-- Fase 3 / Fatia 1 / Marco A: hardening da escrita de cartao.
-- financeiro_cartao_salvar nao altera ativo; arquivar/desarquivar e exclusivo de financeiro_cartao_arquivar.
...
comment on function public.financeiro_cartao_salvar(jsonb, jsonb) is
  'Fase 3 Cartoes: cria ou edita cadastro de cartao sem alterar ativo; arquivamento fica em financeiro_cartao_arquivar.';
