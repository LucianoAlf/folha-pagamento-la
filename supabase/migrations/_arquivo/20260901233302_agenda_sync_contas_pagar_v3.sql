-- data_conclusao usa a data de calendario UTC de contas_pagar.data_pagamento, ao meio-dia SP (R13).
-- Todo caminho de escrita grava a data escolhida como meia-noite UTC (app: 'YYYY-MM-DD' -> timestamptz
-- em sessao UTC; maria_contas_dar_baixa: date::timestamptz) ou meia-noite SP (contas_contas_ajustar_paga,
-- 03:00 UTC), e nos dois casos a data UTC e a data escolhida — a data SP do instante seria o dia anterior.
-- Medido em producao: a data UTC bate com o valor gravado pelo cliente legado em 426 de 426 espelhos
-- pagos na janela; a data SP (v2, 20260901232341) batia em 1 de 426. Corrige o achado 1 da revisao.
-- Restante do corpo identico a v2 (inclusive o R11: orfa com filha ativa fica de fora do delete).
