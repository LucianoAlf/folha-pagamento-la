          ...
          <div>
            ...
            <div className="relative">
              ...
              <input
                ...
                placeholder="0,00"
                className="w-full pl-12 pr-4 py-2.5 bg-surface/40 border border-line rounded-xl text-secondary text-sm focus:outline-none focus:border-accent/50 transition-colors"
              />
            </div>
