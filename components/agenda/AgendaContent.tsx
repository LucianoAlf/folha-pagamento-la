  ...
  return (
    <section className="flex-1 min-w-0 bg-slate-950/85">
      <div className="h-full flex flex-col">
        <div className="p-6 border-b border-slate-800/60 bg-slate-950/60">
          <AgendaHeader
            leftIcon={leftIcon}
                  ...
                  <div className="rounded-2xl border border-slate-800/60 bg-slate-950/95 overflow-hidden">
                    ...
                    >
                      <div className="flex items-center gap-3">
                        ...
                        <div className="text-sm font-black text-rose-200">Atrasadas</div>
                        <Badge variant="warning">{tarefasAtrasadas.length}</Badge>
                      </div>
                      <div className="text-[10px] font-black uppercase tracking-[0.2em] text-slate-500">Prioridade máxima</div>
                    </button>
                    {!collapsed.atrasadas ? (
                      <div className="p-2">
                  ...
                  <div className="rounded-2xl border border-slate-800/60 bg-slate-950/95 overflow-hidden">
                    ...
                    >
                      <div className="flex items-center gap-3">
                        ...
                        <div className="text-sm font-black text-white">Hoje</div>
                        <Badge variant="info">{tarefasHoje.length}</Badge>
                      </div>
                      <div className="text-[10px] font-black uppercase tracking-[0.2em] text-slate-500">Foco do dia</div>
                    </button>
                    {!collapsed.hoje ? (
                      <div className="p-2">
                ...
                <div className="space-y-4">
                  {(() => {
                    if (!isSmartView) {
                      return (
                        <div className="rounded-2xl border border-slate-800/60 bg-slate-950/95 overflow-hidden">
                          <div className="p-2">
                            {tarefas.length === 0 ? (
                              <div className="px-4 py-6 text-sm text-slate-500 font-bold">Nenhuma tarefa nesta lista.</div>
                            ) : (
                              tarefas.map((t) => (
                                <TarefaCard
                                  key={t.id}
                    ...
                    return ordered.length === 0 ? (
                      <div className="rounded-2xl border border-slate-800/60 bg-slate-950/95 overflow-hidden">
                        <div className="px-4 py-6 text-sm text-slate-500 font-bold">Nenhuma tarefa nesta visualização.</div>
                      </div>
                    ) : (
                      ordered.map((g) => (
                        <div key={g.key} className="rounded-2xl border border-slate-800/60 bg-slate-950/95 overflow-hidden">
                          <div className="px-5 py-4 border-b border-slate-800/60 bg-slate-950/95 flex items-center justify-between gap-3">
