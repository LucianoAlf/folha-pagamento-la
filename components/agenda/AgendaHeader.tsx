      ...
      <div className="min-w-0 flex items-start gap-3">
        {isMobile && (
          <button
            ...
            className="p-2 -ml-2 text-muted hover:text-primary hover:bg-surface-2/60 rounded-xl transition-all shrink-0"
        ...
        <div className="min-w-0 flex-1">
          <div className="flex items-center gap-3">
            ...
            <h2 className="text-xl md:text-2xl font-black text-primary truncate tracking-tight uppercase md:normal-case">{title}</h2>
            {rightSlot}
          ...
          {subtitle ? <p className="text-[11px] md:text-sm text-muted font-bold mt-1 tracking-wide line-clamp-1">{subtitle}</p> : null}
        </div>
      </div>
              ...
              <div className="flex items-center gap-1 p-1 rounded-2xl border border-base bg-surface/95 shadow-xl flex-1 min-w-[220px] md:flex-none">
                <button
                  ...
                  className={cn(
                    ...
                    viewMode === 'lista'
                      ? 'bg-accent/15 border-accent/25 text-accent-subtle'
                      : 'border-transparent text-muted hover:text-primary hover:bg-surface/40'
                  )}
                >
                  ...
                  return (
                    <button
                      ...
                      className={cn(
                        ...
                        active ? 'text-primary' : 'text-muted hover:text-primary hover:bg-surface/40'
                      )}
                      aria-label={v.label}
                    >
