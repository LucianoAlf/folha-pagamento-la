...
import { Bell, Calendar, CreditCard, Send, Loader2, Save, Smartphone, Sparkles } from 'lucide-react';
      ...
      <div className="grid grid-cols-1 gap-6">
        ...
        <Card className={cn('p-0 overflow-hidden', cardClass, 'bg-slate-950/95')}>
          <div className="px-6 py-4 border-b border-slate-800/70 flex items-center justify-between">
            ...
            <div className="flex items-center gap-3">
              <div className="text-[10px] text-slate-500 font-black uppercase tracking-[0.2em]">Ativo</div>
              <ToggleSwitch
          ...
          <div className="divide-y divide-slate-800/60">
            <div className="px-6 py-5 grid grid-cols-1 lg:grid-cols-[1fr_420px] gap-4 items-end">
              <div>
              ...
              <div className="flex lg:justify-end">
                <Tooltip content="Enviar uma mensagem de teste para validar o canal" side="top">
                  <button
                    type="button"
                    onClick={handleTesteWhatsApp}
                    disabled={waTesting || !config.whatsapp_ativo || !String(config.whatsapp_numero || '').trim()}
                    className={cn(
                      'inline-flex items-center gap-2 px-5 py-3 rounded-xl border transition-all w-full lg:w-auto justify-center',
        ...
        <Card className={cn('p-0 overflow-hidden', cardClass)}>
          ...
          <div className="divide-y divide-slate-800/60">
            <div className="px-6 py-5 grid grid-cols-1 lg:grid-cols-[1fr_420px] gap-4 items-center">
        ...
        <Card className={cn('p-0 overflow-hidden', cardClass)}>
          ...
          <div className="divide-y divide-slate-800/60">
            <div className="px-6 py-5 grid grid-cols-1 lg:grid-cols-[1fr_360px] gap-4 items-center">
              <div>
        ...
        <Card className={cn('p-0 overflow-hidden', cardClass)}>
          ...
          <div className="divide-y divide-slate-800/60">
            <div className="px-6 py-5 grid grid-cols-1 lg:grid-cols-[1fr_420px] gap-4 items-center">
              ...
              <div className="flex items-center gap-2 lg:justify-end">
                ...
                <input
                  ...
                  className={cn(
                    'w-full lg:w-[220px] px-3 py-2.5 rounded-xl bg-slate-900/50 border border-slate-800 text-slate-200 outline-none',
            ...
            <div className="px-6 py-5 grid grid-cols-1 lg:grid-cols-[1fr_420px] gap-4 items-center">
              ...
              <div className="text-[10px] text-slate-500 font-bold uppercase tracking-widest lg:text-right">
                Envia quando existir folha em status <span className="text-slate-300">pendente</span>
              </div>
            </div>
          </div>
        </Card>
