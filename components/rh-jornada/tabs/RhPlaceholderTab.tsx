      ...
      <div className="grid grid-cols-1 xl:grid-cols-[1.2fr_.8fr] gap-6">
        <Card className="p-6 border border-line-strong/50">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
            {highlights.map((item) => (
              <div key={item} className="rounded-2xl border border-line bg-surface/40 p-4">
        ...
        <Card className="p-6 border border-line-strong/50">
          ...
          <div className="space-y-3">
            {foundation.map((item) => (
              <div key={item} className="rounded-2xl border border-line bg-surface/40 p-4 text-sm text-secondary">
                {item}
              </div>
            ))}
          </div>
