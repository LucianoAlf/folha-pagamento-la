          ...
          <Card className="p-5 border border-line-strong/50">
            <div className="flex flex-col gap-4 lg:flex-row lg:items-start lg:justify-between">
              ...
              <div className="flex flex-wrap gap-2">
                ...
                <button type="button" disabled={!selectedCollaborator || !selectedJourney || saving} onClick={() => setMovementModalOpen(true)} className={cn('px-4 py-2.5 rounded-2xl font-black text-primary', !selectedCollaborator || !selectedJourney || saving ? 'bg-surface-3 opacity-60 cursor-not-allowed' : 'bg-fuchsia-600 hover:bg-fuchsia-500')}>Movimentacao</button>
